...
fake_fixture_expected="streamlens-java-oracle-v3:$fake_fixture_seed:$fake_fixture_digest:$fake_fixture_digest:$fake_fixture_digest:$fake_fixture_digest"
...
[[ $runtime_fixture_expected =~ ^streamlens-java-oracle-v3:${runtime_fixture_seed}:[0-9a-f]{64}:[0-9a-f]{64}:[0-9a-f]{64}:[0-9a-f]{64}$ ]] \
